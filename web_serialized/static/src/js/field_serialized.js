openerp.unleashed.module('web_serialized').ready(function(instance){
    ...
    instance.web_serialized.FieldSerialized = FieldSerialized;
    instance.web.form.widgets.add('serialized', 'openerp.web_serialized.FieldSerialized');
});
